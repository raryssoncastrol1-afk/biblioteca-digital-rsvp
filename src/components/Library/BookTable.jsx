              ...
              <tr key={book.id} className="hover:bg-slate-800/40 transition">
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <button
                      onClick={() => onOpenDetails && onOpenDetails(book.id)}
                      className="p-2.5 rounded-lg border border-slate-700 hover:bg-slate-800 text-indigo-400 hover:text-indigo-300 transition"
                    ...
                    <button
                      ...
                      className="p-2.5 rounded-lg border border-slate-700 hover:bg-slate-800 text-slate-400 hover:text-slate-200 transition"
                    ...
                    <button
                      ...
                      className="p-2.5 rounded-lg text-slate-500 hover:text-red-400 hover:bg-slate-800 transition"
                      title="Excluir"
                    >
